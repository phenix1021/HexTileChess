...
void surf (Input IN, inout SurfaceOutput o) {
	...
	reflcol *= tex.a;
	o.Emission = reflcol.rgb * _ReflectColor.rgb * (1-illum.a *_Shininess)+ illum.rgb * illum.a *_Shininess;
	o.Alpha = reflcol.a * _ReflectColor.a *  (1-illum.a *_Shininess)+ illum.a *_Shininess;
}
ENDCG
}
